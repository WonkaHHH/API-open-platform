...
import com.xiaoxi.xiapi.model.dto.user.UserRegisterRequest;
import com.xiaoxi.xiapi.model.dto.user.UserUpdateMyRequest;
import com.xiaoxi.xiapi.model.dto.user.UserUpdateRequest;
...
//    }
    ...
    public BaseResponse<DevKeyVO> getDevKey(HttpServletRequest request){

        User loginUser = userService.getLoginUser(request);

        DevKeyVO devKeyVO = new DevKeyVO();
        devKeyVO.setAccessKey(loginUser.getAccessKey());
        devKeyVO.setSecretKey(loginUser.getSecretKey());

        return ResultUtils.success(devKeyVO);
    }

    @GetMapping("/updateDevKey")
    public BaseResponse<DevKeyVO> updateDevKey(HttpServletRequest request){
